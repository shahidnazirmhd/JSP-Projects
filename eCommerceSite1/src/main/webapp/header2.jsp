...
<input type="hidden" name="category" value="shirts"></form>
<form id="pant" action="pants.do" method="POST">
<input type="hidden" name="formid" value="categ">
<input type="hidden" name="category" value="pants"></form>
...
<input type="hidden" name="formid" value="categ">
<input type="hidden" name="category" value="tshirts"></form>
<form id="footw" action="footwear.do" method="POST">
<input type="hidden" name="formid" value="categ">
<input type="hidden" name="category" value="footwears"></form>
